...
DEFAULT_FILE_STORAGE = 'Ecommerce_Intern.aws.utils.MediaRootS3BotoStorage'
STATICFILES_STORAGE = 'Ecommerce_Intern.aws.utils.StaticRootS3BotoStorage'
AWS_STORAGE_BUCKET_NAME = 'rental-ecommerce'
